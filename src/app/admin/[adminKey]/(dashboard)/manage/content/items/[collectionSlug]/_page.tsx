...
// import EmptyStateComponent from "@/components/admin/_partials/emptyState";
...
// 				await deleteCollectionItemAction(id, paramsSynced.collectionSlug);
// 			}
...
// 							onCreate={() =>
// 								router.push(
// 									`/admin/${paramsSynced.adminKey}/manage/content/items/${paramsSynced.collectionSlug}/create`,
// 								)
// 							}
// 						/>
// 					</div>
...
// 								onButtonClick={() =>
// 									router.push(
// 										`/admin/${paramsSynced.adminKey}/manage/content/${paramsSynced.collectionSlug}/create`,
// 									)
// 								}
