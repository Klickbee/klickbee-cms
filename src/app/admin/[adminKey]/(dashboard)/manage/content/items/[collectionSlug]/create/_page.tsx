...
export default function CreateCollectionItemPage({
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		if (!title || !slug || !content || !collectionSlug) {
		...
		try {
			...
			router.push(
				`/admin/${params.adminKey}/manage/content/${params.collectionSlug}`,
			);
		} catch (err) {
	...
	return (
		<>
			...
			>
				...
				>
					<Link
						href={`/admin/${params.adminKey}/manage/content/${params.collectionSlug}`}
					>
						<ChevronLeft
							className={
