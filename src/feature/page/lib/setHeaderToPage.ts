...
// This prepares the page so the chosen block can be promoted to the shared Header without duplication.
export function setHeaderToPage(component: ParentBuilderComponent) {
